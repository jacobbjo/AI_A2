...
class Problem:
    ...
    def __init__(self, filename):
        ...
        self.pos_goal = np.array(self.data["pos_goal"])
        self.pos_start = np.array(self.data["pos_start"])
        ...
        self.vel_goal = np.array(self.data["vel_goal"])
        self.vel_start = np.array(self.data["vel_start"])
